...
private def paperRoots : Array PaperRoot := #[
  ...
  ⟨"Theorem 1.1 (endpoint exponent identity)",
    `FirstPassageLinearTransport.fixedPolylogCriticalExponent_eq_entropy⟩,
  ...
  ⟨"Theorem 1.1 (strict parameter selection)",
    `FirstPassageLinearTransport.exists_fixedPolylogParameterPackage⟩,
  ⟨"Theorem 1.1 (literal terminal witness)",
    `FirstPassageLinearTransport.eventually_twoRegimePolylogGood_has_shellLanding⟩,
  ⟨"Theorem 1.1 (same-witness orbit ceiling)",
    `FirstPassageLinearTransport.eventually_twoRegimePolylogGood_has_shellLanding_with_orbitCeiling⟩,
  ⟨"Theorem 1.1 (assembled quantitative theorem)",
    `FirstPassageLinearTransport.fixedPolylogNaturalDensityDescent⟩,
